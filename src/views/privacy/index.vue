...
<template>
  <div class="law">
    ...
    <!-- 描述 -->
    <p class="desc">This Privacy Policy describes how your personal information is collected, used, and shared when
      you visit or make a purchase from buykop.com (the “Site”). 
    </p>
    <!-- 1 -->
    <div class="textbox">
    ...
    <!-- 2 -->
    <div class="textbox">
      <div class="textbox-title">How do we use your personal information? </div>
      <div class="textbox-text">
        <p>
    ...
    <!-- 3 -->
    <div class="textbox">
      <div class="textbox-title">Sharing you personal Information</div>
      <div class="textbox-text">
        <p>
    ...
    <!-- 6 -->
    <div class="textbox">
      <div class="textbox-title">Your rights</div>
      <div class="textbox-text">
        <p>
    ...
    <!-- 7 -->
    <div class="textbox">
      <div class="textbox-title">Data retention</div>
      <div class="textbox-text">
        <p>
    ...
    <!-- 8 -->
    <div class="textbox">
      <div class="textbox-title">Changes </div>
      <div class="textbox-text">
        <p>
    ...
    <!-- 9 -->
    <div class="textbox">
      <div class="textbox-title">Minors </div>
      <div class="textbox-text">
        <p>
    ...
    <!-- 10 -->
    <div class="textbox">
      <div class="textbox-title">Contact us </div>
      <div class="textbox-text">
        <p>
          For more information about our privacy practices, if you have questions, or if you would like to make a
          complaint, please contact us by e?mail at <span style="color:rgb(44, 113, 240)">service@buykop.com</span>
        </p>
      </div>
    </div>
  </div>
