  ...
  <div class="law">
    ...
    <div class="textbox">
      ...
      <div class="textbox-text">
        <p>This website is operated by FormulaRay. Throughout the site, the terms <b>“we”</b>, <b>“us”</b> and
          <b>“our”</b>
          refer to
          FormulaRay. FormulaRay offers this website, including all information, tools and services available
          from this
    ...
    <div class="textbox">
      ...
      <div class="textbox-text">
        <p>
          ...
          In no case shall FormulaRay, our directors, officers, employees, affiliates, agents, contractors, interns,
    ...
    <div class="textbox">
      ...
      <div class="textbox-text">
        <p>
          You agree to indemnify, defend and hold harmless FormulaRay and our parent, subsidiaries, affiliates,
    ...
    <div class="textbox">
      ...
      <div class="textbox-text">
        <p>
          ...
          written, between you and us (including, but not limited to, any prior versions of the Terms of Service). <br>
    ...
    <div class="textbox">
      ...
      <div class="textbox-text">
        <p>
          ...
          It is your responsibility to check our website periodically for changes. Your continued use of or access to
      ...
      <div class="textbox-text">
        <p>
          Questions about the Terms of Service should be sent to us at <span
                style="color:rgb(44, 113, 240)">service@buykop.com</span>.
        </p>
      </div>
    </div>
  </div>
